...
const songs = [
    {
        id:'1',
        songName:` Aayee Hai Diwali  `,

        poster: "img/sanu/sanu.jpeg",
    },
    {
        id:'2',
        songName:`Dil Bhi Rone Laga `,
    ...
    {
        id:"5",
        songName: `Pyar Dilon Ka Mela Hai`,
        poster:  "img/sanu/sanu.jpeg",
    },
    {
        id:"6",
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((element)=>{
    element.addEventListener('click', (e)=>{
        ...
        poster_master_play.src =`img/sanu/${index}.jpeg`;
        music.play();
